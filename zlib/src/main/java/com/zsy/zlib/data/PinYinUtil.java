...
public class PinYinUtil {
     ...
     * 只支持简化字
     */
    public static String getSelling(String chs, boolean separate) {
        String key, value;
    ...
    public static void main(String[] args) {
        System.out.println("<" + getSelling("累计发电量", true) + ">");
    }
