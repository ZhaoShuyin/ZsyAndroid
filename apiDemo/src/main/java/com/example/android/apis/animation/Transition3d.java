...
public class Transition3d extends Activity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private void applyRotation(int position, float start, float end) {
        ...
        rotation.setAnimationListener(new AnimListener(position));
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        applyRotation(position, 0, 90);//左翻显示图片
    }

    @Override
    public void onClick(View v) {
        applyRotation(-1, 180, 90);//右翻显示列表
    }
    ...
    private final class AnimListener implements Animation.AnimationListener {
        ...
        private AnimListener(int position) {
            mPosition = position;
        }
        ...
        public void onAnimationEnd(Animation animation) {
            mContainer.post(new SwapViewsRunnable(mPosition));
        }
    ...
    private final class SwapViewsRunnable implements Runnable {
        ...
        public SwapViewsRunnable(int position) {
            mPosition = position;
        }
